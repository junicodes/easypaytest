  ...
  return (
    <>
      <div className='border h-1/2 rounded-lg p-4 pt-6'>
        <h1 className='mb-3 text-lg font-medium'>Activities</h1>
        <div className="m-3 bg-white rounded-md flex justify-start space-x-3 items-start h-auto">
          <div className='pb-4 border-l w-full relative'>
