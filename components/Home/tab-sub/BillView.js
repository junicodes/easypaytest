  ...
  return (
    <div className="border h-1/2 rounded-lg">
      <div className="flex flex-col justify-center items-center mt-6">
        ...
        <p
          className="text-gray-600 font-semibold text-xs mt-2 text-left leading-normal"
          style={{ fontSize: "9px" }}
        >
          Starbuck - Caramet Latte Grande &
        </p>
        <p
          className="text-gray-600 font-semibold text-xs my-1 text-left leading-normal"
          style={{ fontSize: "9px" }}
        >
      ...
      <div className="p-4">
        ...
        <button className='w-full h-12 mt-4 rounded-xl' style={{background: "#154ea5"}}>
