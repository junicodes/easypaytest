    ...
    <div className='xl:container mx-auto px-10'>
        ...
        <div className='w-full md:w-11/12 mx-auto h-64 flex flex-col md:flex-row justify-center md:justify-between item-center p-14 px-10 2xl:px-20 mb-20 md:mb-40 rounded-lg'  style={{background: '#0e3d83'}}>
            <div className='w-full md:w-3/4'>
                <h1 className='text-white text-center md:text-left font-semibold mb-3' style={{fontSize: `${isTab ? '36px' : '52px'}`}}>Let&apos;s try our service now!</h1>
                <p className='text-white text-center md:text-left text-sm xl:text-xl'>Easy to use API that allow you to get up and running with <br></br>
