...
const Footer = () => {
    return (
        <div className='container mx-auto px-10 mt-20'>
            ...
            <footer className="p-4 border-t border-gray-200 footer bg-white sm:p-6">
                <div className="md:flex md:justify-between items-start pt-16">
                    <div className="mb-6 md:mb-0">
                        ...
                        <div className='flex justify-start items-center space-x-3 mt-5 cursor-pointer'>
                           <img className="w-10 h-4" src="/images/connect-visa.jpg" alt="user image" />
                           <img className="w-10 h-6" src="/images/connect-master-card.jpg" alt="user image" />
                           <img className="w-8 h-4" src="/images/connect-apple.jpg" alt="user image" />
                           <img className="w-10 h-4" src="/images/connect-gpay.jpg" alt="user image" />
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-16 sm:grid-cols-3">
                        <div>
                            <ul className="text-gray-500">
                                 <li className="mb-4">
                                    <a href="#" className=""text-lg>Community</a>
                                </li>
                                <li className="mb-4">
                        ...
                        <div>
                            <ul className="text-gray-500">
                                ...
                                <li className="mb-4">
                                    <a href="#" className="text-lg">Partner with us</a>
                                </li>
                                <li className="mb-4">
                    ...
                    <div className="flex mt-4 space-x-3 sm:justify-center sm:mt-0">
                        <a href="#" className="text-gray-600 border p-3 rounded-full">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path></svg>
                        </a>
                        <a href="#" className="text-gray-600 border p-3 rounded-full">
                ...
                <div className="sm:flex sm:items-center sm:justify-between pt-20">
                    <span className="text-sm text-gray-400 sm:text-cente">
                        © 2022 <a href="#" className="hover:underline">Easypay™</a>. All Rights Reserved.
                    </span>
